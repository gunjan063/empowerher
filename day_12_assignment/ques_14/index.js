...
function evaluateEmployees(employeeArray) {

  const filtered = employeeArray.filter(emp => emp.tasksCompleted > 5);
  ...
  const sorted = mapped.sort((a, b) => performanceOrder[b.performance] - performanceOrder[a.performance]);
